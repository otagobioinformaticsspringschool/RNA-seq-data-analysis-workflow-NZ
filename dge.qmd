...
design <- model.matrix(~histology, data = coldata)
...
::: {.callout-warning}
# CHECK
Currently design not looking correct - comapre in Rstudio. miht be different counts/coldata loaded. 

think samples need to be in the same order a counts df
...
Voom should stabilise mean-variance without removing differecnes between sample groups
